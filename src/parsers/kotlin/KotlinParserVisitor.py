...
class KotlinParserVisitor(ParseTreeVisitor):
    ...
    def visitConstructorInvocation(
    ...
    def visitConstructorDelegationCall(
    ...
    def visitMultiVariableDeclaration(
    ...
    def visitFunctionTypeParameters(
    ...
    def visitTypeProjectionModifierList(
    ...
    def visitMultiLineStringLiteral(
    ...
    def visitMultiplicativeOperation(
    ...
    def visitPostfixUnaryOperation(
    ...
    def visitTypeParameterModifier(
    ...
    def visitAnnotationUseSiteTarget(
