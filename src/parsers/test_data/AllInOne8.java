     ...
     */
     public static void main(String[] args) {
        ...
        printNames("Names filtered by predicate:", list.toArray(new Name[list.size()]));
                ...
                arator<Name> com1 = Comparator.comparing((Name name1) -> name1.lastName)
            .thenComparing(name2 -> name2.firstNa me);
                arator<Name> com2 = Comparator.<Name,String>comparing(name1 -> name1.lastName)
...
public class Annos {
    ...
    @Documented
    @Retentio n(RetentionPolicy.RUNTIME) 
 ...
 public static @Dummy4("#1") @Dummy1 @Dummy3 <T extends @Dummy2 @Dummy
            3 Object>
    @Dummy1 @Dummy3 T @Dummy1 @Dummy3 [] foo(@Dummy1 T @Dummy2 @Dummy3 [] arr, @Dummy1 @Dummy3 T @Dummy1 @Dummy3 ... t) {
        return (@Dummy1 @Dummy3 T[]) null;
    }

 public static @Dummy4("") <@Dummy1 @Dummy2 T extends @Dummy1 @Dummy3 Object>
