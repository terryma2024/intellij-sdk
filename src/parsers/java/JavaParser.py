...
class JavaParser(Parser):
    ...
    def enumBodyDeclarations(self):
        ...
        try:
            ...
            _la = self._input.LA(1)
            while (
                ((_la - 1) & ~0x3F) == 0 and ((1 << (_la - 1)) & -665791937994347) != 0
            ) or (
                ((_la - 65) & ~0x3F) == 0
    ...
    def interfaceBody(self):
        ...
        try:
            ...
            _la = self._input.LA(1)
            while (
                ((_la - 1) & ~0x3F) == 0 and ((1 << (_la - 1)) & -665791937992299) != 0
            ) or (
                ((_la - 65) & ~0x3F) == 0
    ...
    def genericInterfaceMethodDeclaration(self):
        ...
        try:
            ...
            _la = self._input.LA(1)
            while (
                ((_la - 1) & ~0x3F) == 0 and ((1 << (_la - 1)) & -1125470410110975) != 0
            ) or (
                ((_la - 65) & ~0x3F) == 0
    ...
    def annotationTypeBody(self):
        ...
        try:
            ...
            _la = self._input.LA(1)
            while (
                ((_la - 1) & ~0x3F) == 0 and ((1 << (_la - 1)) & -806529426349675) != 0
            ) or (
                ((_la - 65) & ~0x3F) == 0
                and ((1 << (_la - 65)) & -8935141660702539773) != 0
            ):
    ...
    def block(self):
        ...
        try:
            ...
            _la = self._input.LA(1)
            while (
                ((_la - 1) & ~0x3F) == 0 and ((1 << (_la - 1)) & -334254282492513) != 0
            ) or (
                ((_la - 65) & ~0x3F) == 0
            ...
            while _alt != 2 and _alt != ATN.INVALID_ALT_NUMBER:
                if _alt == 1:
                    ...
                    if la_ == 1:
                        ...
                        _la = self._input.LA(1)
                        if not (
                            ((_la - 88) & ~0x3F) == 0 and ((1 << (_la - 88)) & 387) != 0
                        ):
                            localctx.bop = self._errHandler.recoverInline(self)
                        else:
                            self._errHandler.reportMatch(self)
